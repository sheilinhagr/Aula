...
python -m venv (nomedapastadeambientevirtualasercriada)
python -c 'cmd' (comando)
python -c 'print("oi")'
python --> quit()  executa comando no terminal diretamente
python -i mod.py (interativo com mod)
python -i aula57.py executa o arquivo

The Zen of Python, por Tim Peters
python -c 'import this' no terminal
